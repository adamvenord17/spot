    ...
    testWidgets('Renders ViewVideoPage', (tester) async {
      ...
      when(() => repository.getVideoDetailStream('aaa')).thenAnswer((_) => Future.value(
            VideoDetail(
              ...
              imageUrl: 'https://adamvenord17.dev/images/profile.jpg',
              thumbnailUrl: 'https://adamvenord17.dev/images/profile.jpg',
              gifUrl: 'https://adamvenord17.dev/images/profile.jpg',
